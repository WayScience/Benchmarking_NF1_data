...
# # Create 2D UMAP using number of single cells
...
sns_plot = sns.scatterplot(
    ...
    hue=embeddings_data["Metadata_number_of_singlecells"]
)
# Adjust legend
sns_plot.legend(
    loc="center left", bbox_to_anchor=(1, 0.5), title='number of single cells'
)
# Label axes, title
...
save_path = pathlib.Path("UMAPs/2D_umap_nf1_num_sc.png")
