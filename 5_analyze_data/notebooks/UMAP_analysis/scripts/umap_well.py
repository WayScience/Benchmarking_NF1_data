...
sns_plot = sns.scatterplot(
    ...
    hue=embeddings_data["Metadata_Well"]
)
# Adjust legend
sns_plot.legend(
    loc="center left", bbox_to_anchor=(1, 0.5), title='well'
)
# Label axes, title
...
save_path = pathlib.Path("UMAPs/2D_umap_nf1_well.png")

plt.savefig(save_path, bbox_inches="tight")


# ## Create 2D UMAP using well column number
...
sns_plot = sns.scatterplot(
    ...
    x=embeddings_data['UMAP1'],
    y=embeddings_data['UMAP2'],
    hue=embeddings_data["Metadata_WellCol"]
)
# Adjust legend
sns_plot.legend(
    loc="center left", bbox_to_anchor=(1, 0.5), title='well column number'
)
# Label axes, title
sns_plot.set_xlabel("UMAP 1")
sns_plot.set_ylabel("UMAP 2")
...
save_path = pathlib.Path("UMAPs/2D_umap_nf1_well_column_num.png")
